...
//              .addMixIn(Resource.class, IdSupportMixin.class)
     ...
     */
    @Bean
    public RequestInterceptor requestTokenBearerInterceptor(ActivitiResourceOwnerPasswordResourceDetails activitiResourceOwnerPasswordResourceDetails) {
        OAuth2RestTemplate oauth2RestTemplate = new OAuth2RestTemplate(activitiResourceOwnerPasswordResourceDetails,
